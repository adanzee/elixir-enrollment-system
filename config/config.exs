...
config :student_live, StudentLiveWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: StudentLiveWeb.ErrorHTML, json: StudentLiveWeb.ErrorJSON],
    layout: false
  ],
...
config :student_live, StudentLive.Mailer, adapter: Swoosh.Adapters.Local
