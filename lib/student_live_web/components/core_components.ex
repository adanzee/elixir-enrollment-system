defmodule StudentLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StudentLiveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StudentLiveWeb.Gettext, "errors", msg, opts)
    end
  end
